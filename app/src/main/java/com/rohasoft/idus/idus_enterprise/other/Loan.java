...
public class Loan {
    ...
    String customer_name,customer_id,phone,address,city,pincode,loan_amount,loan_option,loan_duration,
            start_date,end_date,remarks,current_due_date,current_due_amount,cusImg,shoImg,idImg,addressImg,user,tomor_due_date ;
    ...
    public Loan(String customer_name, String customer_id, String phone, String address, String city, String pincode, String loan_amount,
                String loan_option, String loan_duration, String start_date, String end_date, String remarks, String current_due_date,String tomor_due_date,
